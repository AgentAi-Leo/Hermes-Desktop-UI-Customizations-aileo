...
print('GIT_WATCH_R57_NESTED_LEDGER_REJECTION=PASS')
PY
shasum -a 256 -c CHECKSUMS.sha256
node --check payload/dashboard/dist/index.js
node tests/test_renderer_r57.js payload/dashboard/dist/index.js
node tests/test_visual_r57.js
