9aea0e209c7fa009a8a3db62','05b04f77528d19122247e127223a8cc9314ddbc6da8ce4731c5b51cda1a2ccb0','009232d9ea2deb23789bf7d6a231bcf1c15fedc875ae7b43f0fa6f7ab1082300','dd2564dfed1f742884fd06c3e0ad6890cf26b311bad97cd663346c68e08a52ca','543abd906f88f17c1a679527820ae9a939ed1377ced0f787ee8b04640ca8e046'},False),
...
root=Path(sys.argv[1]); expected={
 'web/src/App.tsx':'23ee49caa33b6f838435163fa66dd1d8f01cd843563d8e7aa4be12ff84c66c17',
 ...
 'web/src/lib/persistent-fullscreen.test.ts':'1fcd2e655ceb8df6fe7b64c66b1a46debce6c07568bf2f7a1aa39a2541c068c6',
}
...
for required in ('const isPersistentBriefRoute = normalizedPath === "/briefs-ai" || normalizedPath === "/brief-stock";','h-dvh overflow-y-auto overflow-x-hidden bg-background-base p-0'):
    if required not in app: raise SystemExit(f'GIT_WATCH_FULLSCREEN_SCROLL_CONTRACT_MISSING={required}')
...
for required in ('if (!isPersistentFullscreen || !isPersistentBriefRoute) return;','shell.scrollTop = 0;','shell.addEventListener("scroll", lockFullscreenShellScroll','requestAnimationFrame(lockFullscreenShellScroll)','shell.removeEventListener("scroll", lockFullscreenShellScroll'):
...
for required in ('keeps one AI toolbar mounted when fullscreen state and date-loaded content change','uses one complete AI rail in every mode','restores each AI date to its own focused card and viewport','not.toContain(\'{isPersistentFullscreen && kind === "ai" && (\')'):
...
for required in ('data-hermes-ai-persistent-toolbar','renderExportButtons("ai-persistent-toolbar")','aria-label="Previous AI topic"','aria-label="Next AI topic"','aria-label="AI narration volume"','aria-label="AI playback speed"','aria-label="Load newer AI brief date"','aria-label="Load older AI brief date"','prepareBriefPreviewHtml(sourceHtml, kind, selected.generated_at, selected.date, kind === "ai")','pendingAiViewportPositionRef.current = aiViewportByDateRef.current.get(targetDate)'):
    if required not in page: raise SystemExit(f'AI_GOLD_TOOLBAR_PAGE_CONTRACT_MISSING={required}')
for required in ('aiViewportByDateRef','activeAiPreviewDateRef','aiViewportByDateRef.current.set(activeDate','topicIndex: Math.trunc(position.topicIndex)','pendingAiViewportPositionRef.current = aiViewportByDateRef.current.get(targetDate)'):
    if required not in page: raise SystemExit(f'AI_PER_DATE_VIEWPORT_CONTRACT_MISSING={required}')
