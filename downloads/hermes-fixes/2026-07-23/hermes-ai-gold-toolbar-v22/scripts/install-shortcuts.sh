...
BACKUP_ROOT="$PROFILE_HOME/backups/hermes-ai-gold-toolbar-v22"
...
root=Path(sys.argv[1]); expected={
 ...
 'web/src/lib/briefs.ts':'37cc33f66a9067b05ead8924b9070ac3b17d9315120a08a047937dcfd4b80491',
 'web/src/lib/briefs.test.ts':'9d8aab9c42b58d881df022607e846db79877ac495c2ef4ed648ea5d938097903',
 'web/src/pages/BriefsPage.tsx':'05b04f77528d19122247e127223a8cc9314ddbc6da8ce4731c5b51cda1a2ccb0',
