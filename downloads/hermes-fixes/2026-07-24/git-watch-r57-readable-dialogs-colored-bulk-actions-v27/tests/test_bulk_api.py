...
MODULE_PATH = Path(os.environ.get("GIT_WATCH_API_PATH", Path(__file__).resolve().parents[1] / "dashboard" / "plugin_api.py"))
spec = importlib.util.spec_from_file_location("git_watch_r55_api", MODULE_PATH)
