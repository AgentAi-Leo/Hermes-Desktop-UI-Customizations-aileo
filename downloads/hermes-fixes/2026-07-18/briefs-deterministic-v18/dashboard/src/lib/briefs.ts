...
.hermes-stock-summary-value { display: block !important; font-size: 64px !important; line-height: 1.05 !important; font-weight: 850 !important; white-space: nowrap !important; }
...
@media (max-width: 900px) { body > header h1, body > main > header h1, .wrap > header h1, .hero h1 { font-size: 48px !important; } .hermes-stock-heading-row { flex-direction: column !important; } .hermes-stock-portfolio-summary { margin-left: 0 !important; text-align: left !important; } .hermes-stock-summary-value { font-size: 48px !important; } }
</style>`;
