...
script:oldObfuscatedLink()">Obfuscated unsafe link</a>
  ...
  it("adds one Stock header summary from the portfolio total without changing CSV bytes", () => {
    ...
    expect(result).toContain(".hermes-stock-summary-value { display: block !important; font-size: 64px !important; line-height: 1.05 !important; font-weight: 400 !important;");
    expect(result).not.toContain(".hermes-stock-summary-value { display: block !important; font-size: 64px !important; line-height: 1.05 !important; font-weight: 850 !important;");
