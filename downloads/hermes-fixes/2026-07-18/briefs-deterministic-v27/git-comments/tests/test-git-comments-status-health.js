...
assert(source.includes('.git-comments-success{position:fixed;left:50%;top:50%;z-index:1100;width:max-content;min-width:min(523.25px,calc(100vw - 62.4px));max-width:calc(100vw - 62.4px);min-height:min(114.4px,calc(100vh - 62.4px));box-sizing:border-box;transform:translate(-50%,-50%);') && source.includes('display:flex;align-items:center;justify-content:center') && source.includes('padding:39px 62.4px') && source.includes('font-size:30.55px') && source.includes('color:rgba(255,255,255,.9)') && source.includes('border:1px solid #fff;border-radius:7px') && source.includes('white-space:nowrap') && source.includes('box-shadow:0 15.6px 41.6px rgba(0,0,0,.6),0 5.2px 15.6px rgba(0,0,0,.36)') && source.includes('backdrop-filter:blur(5.2px)') && source.includes('transition:opacity .5s ease'), "center popup must use the exact 35%-reduced nonwrapping geometry with a thin white border and 7px corner radius");
...
assert(source.includes('background:rgba(18,60,43,.8)') && source.includes('.git-comments-success.cyan{border-color:#fff;background:rgba(8,51,68,.8);color:rgba(255,255,255,.9)}') && source.includes('.git-comments-success.red{border-color:#fff;background:rgba(74,21,27,.8);color:rgba(255,255,255,.9)}') && !source.includes('.git-comments-success{opacity:.8'), "popup backgrounds must remain 80% opaque while every action tone uses a thin white border and 90%-opaque white text");
...
assert(source.includes('padding:39px 62.4px;border:1px solid #fff;border-radius:7px;'), "success popup must use 35%-reduced padding with a thin white border and 7px corner radius");
...
assert(source.includes('box-shadow:0 15.6px 41.6px rgba(0,0,0,.6),0 5.2px 15.6px rgba(0,0,0,.36);backdrop-filter:blur(5.2px)'), "success shadow and blur must be reduced exactly 35%");
assert(source.includes('.git-comments-success.cyan{border-color:#fff;background:rgba(8,51,68,.8);color:rgba(255,255,255,.9)}'), "archive success must retain cyan surface styling with the thin white border and 90%-opaque white text");
assert(source.includes('.git-comments-success.red{border-color:#fff;background:rgba(74,21,27,.8);color:rgba(255,255,255,.9)}'), "delete success must retain red surface styling with the thin white border and 90%-opaque white text");
