...
BACKUP_ROOT="$PROFILE_HOME/backups/hermes-persistent-custom-fullscreen-v16"
...
expected={
 'web/src/App.tsx':('738460661a74426b4e4da2fde482aee5a54b17e6f575d5dde1c1702161620faf',{'9bdbf9a04260cd2eccb34be0568b8f8832d4f13147f4746accd31d3342cb6ffc','1b51a2aeaaa82e6f79e8e03f57885ce905ff91f00d3441d38a31c63d2d503bbc','738460661a74426b4e4da2fde482aee5a54b17e6f575d5dde1c1702161620faf'},False),
 ...
 'web/src/pages/BriefsPage.tsx':('646cd3df8467f6f2adee3d2bec89397af3c8849d7872938adf81c3e405445238',{'4de05bc3cad0c087324de7e247f5afe639a74351d1348974237503a948ad10e7','646cd3df8467f6f2adee3d2bec89397af3c8849d7872938adf81c3e405445238'},False),
 'web/src/lib/persistent-fullscreen.ts':('f029c30327f8f4011d864308c992a13653c79cad557536c42a662da9b6ff347e',{'f029c30327f8f4011d864308c992a13653c79cad557536c42a662da9b6ff347e'},True),
 'web/src/lib/persistent-fullscreen.test.ts':('b96273d36626fefe2577b566d8e918a67d14c0eb5c7de200cd3dc21ad8b70197',{'b96273d36626fefe2577b566d8e918a67d14c0eb5c7de200cd3dc21ad8b70197'},True),
}
...
root=Path(sys.argv[1]); expected={
 'web/src/App.tsx':'738460661a74426b4e4da2fde482aee5a54b17e6f575d5dde1c1702161620faf',
 ...
 'web/src/pages/BriefsPage.tsx':'646cd3df8467f6f2adee3d2bec89397af3c8849d7872938adf81c3e405445238',
 'web/src/lib/persistent-fullscreen.ts':'f029c30327f8f4011d864308c992a13653c79cad557536c42a662da9b6ff347e',
 'web/src/lib/persistent-fullscreen.test.ts':'b96273d36626fefe2577b566d8e918a67d14c0eb5c7de200cd3dc21ad8b70197',
}
...
for required in ('customShortcutPaths','sidebarNav.customItems.map((item) => item.path)','customTabIndexForShortcut(key, customShortcutPaths.length)','PERSISTENT_FULLSCREEN_SHELL_ID','fullscreenShellRef','data-hermes-persistent-fullscreen-control','isBriefFullscreenToggleMessage(event.data?.type)','BRIEF_FULLSCREEN_STATE_MESSAGE_TYPES.forEach','event.key === "Enter" && customShortcutPaths.includes(normalizedPath)'):
...
for required in ('hermes-persistent-route-shell','hermes-ai-fullscreen-toggle','hermes-stock-fullscreen-toggle','hermes-ai-fullscreen-state','hermes-stock-fullscreen-state'):
...
for required in ('/briefs-ai','/brief-stock','/git-comments-v27-review','hermes-custom-tab-shortcut','hermes-persistent-route-shell','hermes-ai-fullscreen-toggle','hermes-stock-fullscreen-toggle'):
