...
```txt
releases/2026-07-12-terminalfix/
```
...
```bash
bash /path/to/Hermes-Desktop-UI-Customizations-aileo/releases/2026-07-12-terminalfix/scripts/apply-customizations.sh --dry-run
```

If dry-run succeeds, apply:

```bash
bash /path/to/Hermes-Desktop-UI-Customizations-aileo/releases/2026-07-12-terminalfix/scripts/apply-customizations.sh --apply
```
...
```bash
bash /path/to/Hermes-Desktop-UI-Customizations-aileo/releases/2026-07-12-terminalfix/scripts/verify-customizations.sh
```
...
```txt
releases/2026-07-12-terminalfix/patches/001-responsive-composer-layout.patch
releases/2026-07-12-terminalfix/patches/002-voice-playback-state-and-library.patch
releases/2026-07-12-terminalfix/patches/003-composer-playback-controls-and-esc.patch
releases/2026-07-12-terminalfix/patches/004-prompt-copy-button.patch
releases/2026-07-12-terminalfix/patches/005-i18n-labels.patch
```
...
```txt
releases/2026-07-12-terminalfix/docs/maintainer-notes.md
releases/2026-07-12-terminalfix/manifest.json
```
