...
<script>${inlineScript}<\/script>
  ...
  function GitCommentsPage() {
    ...
    const showSuccess = (message, duration, tone = "green") => { setSuccessFading(false); setSuccessTone(tone); setSuccessDuration(duration); setActionSuccess(message); setSuccessVersion((version) => version + 1); };
