...
node tests/test_renderer_r60.js payload/dashboard/dist/index.js
node tests/test_visual_r60.js
if [[ "${GIT_WATCH_R60_SKIP_SURFACE_MUTANTS:-0}" != "1" ]]; then bash tests/test_surface_mutants_r60.sh; fi
