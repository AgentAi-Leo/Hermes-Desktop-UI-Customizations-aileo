...
print('GIT_WATCH_R55_NESTED_LEDGER_REJECTION=PASS')
PY
shasum -a 256 -c CHECKSUMS.sha256
node --check payload/dashboard/dist/index.js
node tests/test_renderer_r55.js payload/dashboard/dist/index.js
...
print('GIT_WATCH_R55_API_SYNTAX=PASS')
PY
...
echo "GIT_WATCH_R55_PACKAGE_VERIFICATION=PASS"
