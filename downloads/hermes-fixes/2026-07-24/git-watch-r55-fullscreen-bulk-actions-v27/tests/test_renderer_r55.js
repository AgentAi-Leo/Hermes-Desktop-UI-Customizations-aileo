...
assert(source.includes('<meta name="git-watch-export-version" content="55">'), 'export schema must advance to Revision 55');
assert(source.includes('<meta name="git-watch-visual-baseline" content="55">'), 'visual baseline must identify Revision 55');
assert(source.includes('Export format 55 · Visual baseline 55'), 'visible export provenance must identify Revision 55');
...
console.log('GIT_WATCH_R55_RENDERER_CONTRACT=PASS');
