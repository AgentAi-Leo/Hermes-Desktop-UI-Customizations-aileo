# Briefs host-root migration V22
...
Double-click `INSTALL_BRIEFS_HOST_ROOTS_V22.command`, or run it in Mac Terminal. Successful output ends with:

```text
BRIEFS_HOST_ROOTS_V22_INSTALL=PASS
