...
BACKUP_ROOT="$PROFILE_HOME/backups/hermes-ai-single-rail-clean-top-v25"
...
expected={
 'web/src/App.tsx':('f186b390cffa12ee9216826064645a9568fc10d81428f000e2b4ed85d89bd5f6',{'9bdbf9a04260cd2eccb34be0568b8f8832d4f13147f4746accd31d3342cb6ffc','1b51a2aeaaa82e6f79e8e03f57885ce905ff91f00d3441d38a31c63d2d503bbc','738460661a74426b4e4da2fde482aee5a54b17e6f575d5dde1c1702161620faf','880c7de7b1304c8b6a4527f6717aceb4f9ad9f80ff66590252bfc55beeef964a','c5a92c30dcf036a931aa4830fe0b0de5c72d949abbf22aeb788bb214a5f7522b','a865d956ad935c137063f2f2790f22ac2c44f678632d648cbcd26ea1e79a4956','b48e001813e8af2949cb5d62f545519d152c28769812b7066ccd758579305309','f186b390cffa12ee9216826064645a9568fc10d81428f000e2b4ed85d89bd5f6'},False),
...
root=Path(sys.argv[1]); expected={
 'web/src/App.tsx':'f186b390cffa12ee9216826064645a9568fc10d81428f000e2b4ed85d89bd5f6',
 ...
 'web/src/lib/persistent-fullscreen.test.ts':'9ef4395a90aaf1e5cfe4524b49185eb51ea04a1781445fc36e017f56518b200d',
}
...
for required in ('if (!isPersistentFullscreen) return;','shell.scrollTop = 0;','shell.addEventListener("scroll", lockFullscreenShellScroll','requestAnimationFrame(lockFullscreenShellScroll)','shell.removeEventListener("scroll", lockFullscreenShellScroll'):
...
for required in ('keeps one AI toolbar mounted when fullscreen state and date-loaded content change','uses one complete AI rail in every mode','resets every selected AI date to the clean document top','not.toContain(\'{isPersistentFullscreen && kind === "ai" && (\')'):
