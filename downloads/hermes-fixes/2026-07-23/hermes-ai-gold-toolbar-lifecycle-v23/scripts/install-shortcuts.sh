...
BACKUP_ROOT="$PROFILE_HOME/backups/hermes-ai-gold-toolbar-lifecycle-v23"
...
for required in ('resets stale fullscreen-shell scroll after an iframe load and across two layout frames','shell.scrollTop = 101.5','frames.shift()?.(16)'):
