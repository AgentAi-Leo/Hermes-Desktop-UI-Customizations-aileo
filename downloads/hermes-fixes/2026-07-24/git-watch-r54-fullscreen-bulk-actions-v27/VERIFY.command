...
print('GIT_WATCH_R54_NESTED_LEDGER_REJECTION=PASS')
PY
shasum -a 256 -c CHECKSUMS.sha256
node --check payload/dashboard/dist/index.js
node tests/test_renderer_r54.js payload/dashboard/dist/index.js
...
print('GIT_WATCH_R54_API_SYNTAX=PASS')
PY
...
echo "GIT_WATCH_R54_PACKAGE_VERIFICATION=PASS"
