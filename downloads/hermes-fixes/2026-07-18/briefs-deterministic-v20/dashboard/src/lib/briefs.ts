...
export function stockDateNavigationDirection(key: string): "newer" | "older" | null {
  if (key === "ArrowLeft") return "newer";
  if (key === "ArrowRight") return "older";
  return null;
}
...
#hermes-brief-player .hermes-date-nav-label { display: inline-flex !important; min-height: 42px !important; align-items: center !important; color: #67e8f9 !important; font-size: 42px !important; line-height: 42px !important; font-weight: 400 !important; letter-spacing: .04em !important; white-space: nowrap !important; }
#hermes-brief-player .hermes-date-nav button { width: 42px !important; height: 42px !important; min-width: 42px !important; min-height: 42px !important; margin: 0 !important; border: 1px solid #67e8f9 !important; border-radius: 999px !important; background: rgba(103, 232, 249, .08) !important; color: #67e8f9 !important; font-size: 26px !important; line-height: 1 !important; }
...
.hermes-takeaways-heading-row { display: flex !important; align-items: center !important; gap: 18px !important; flex-wrap: wrap !important; margin: 0 0 1.25rem !important; }
.hermes-takeaways-heading-row h2 { margin: 0 !important; }
.hermes-ai-sources-row { display: flex !important; align-items: center !important; gap: 14px !important; flex-wrap: wrap !important; }
.hermes-ai-sources-row .sources, .hermes-ai-sources-row .source { margin: 0 !important; }
.hermes-ai-active-date-pill { display: inline-flex !important; align-items: center !important; min-height: 34px !important; padding: 6px 14px !important; border-radius: 999px !important; background: #ffd166 !important; color: #0b1020 !important; font-size: 16px !important; font-weight: 850 !important; line-height: 1.2 !important; letter-spacing: .02em !important; white-space: nowrap !important; }
.hermes-takeaways-heading-row .hermes-ai-active-date-pill { transform: translateY(-5px) !important; }
.hermes-ai-sources-row .hermes-ai-active-date-pill { transform: none !important; }
...
.hermes-portfolio-table { width: 100%; min-width: 1360px; table-layout: fixed; border-collapse: collapse; font-variant-numeric: tabular-nums; }
...
.hermes-portfolio-meta { display: block; margin-top: 3px; color: var(--muted, #aab8ca); font-size: 12.2px; font-weight: 500; }
...
/* V21: archive-independent full-width Stock rows. */
...
.hermes-stock-row { grid-column: 1 / -1 !important; width: 100% !important; max-width: none !important; box-sizing: border-box !important; display: grid !important; grid-template-columns: minmax(520px, 1.05fr) minmax(190px, .42fr) minmax(0, 1.75fr) !important; gap: 28px !important; align-items: center !important; margin: 0 !important; padding: 20px 24px !important; border: 1px solid var(--line, #334155) !important; border-radius: 16px !important; background: var(--panel, #111827) !important; box-shadow: none !important; }
...
.hermes-stock-row-date { grid-column: 2 !important; display: inline-flex !important; min-height: 42px !important; align-items: center !important; justify-content: center !important; justify-self: center !important; padding: 9px 18px !important; border-radius: 999px !important; background: #ffd166 !important; color: #0b1020 !important; font-size: 1.05rem !important; font-weight: 850 !important; line-height: 1.15 !important; letter-spacing: .02em !important; text-align: center !important; white-space: nowrap !important; }
.hermes-stock-metrics { grid-column: 3 !important; display: grid !important; grid-template-columns: repeat(5, minmax(132px, 1fr)) !important; gap: 24px !important; align-items: center !important; margin: 0 !important; }
.hermes-stock-metrics > div { min-width: 0 !important; }
.hermes-stock-metrics dt { color: var(--muted, #aab8ca) !important; font-size: 1.15rem !important; font-weight: 700 !important; letter-spacing: .055em !important; line-height: 1.2 !important; text-transform: uppercase !important; }
.hermes-stock-metrics dd { margin: 7px 0 0 !important; color: var(--text, #f4f7fb) !important; font-size: 1.9rem !important; font-weight: 800 !important; line-height: 1.15 !important; font-variant-numeric: tabular-nums !important; white-space: nowrap !important; }
.hermes-stock-row time, .hermes-stock-row [class*="timestamp"], .hermes-stock-row [class*="as-of"] { display: none !important; }
@media (max-width: 1400px) { .hermes-stock-row { grid-template-columns: minmax(380px, .95fr) minmax(160px, .35fr) minmax(0, 1.75fr) !important; gap: 16px !important; } .hermes-stock-company { font-size: 1.05rem !important; } .hermes-stock-row-date { padding: 8px 14px !important; font-size: .9rem !important; } .hermes-stock-metrics { grid-template-columns: repeat(5, minmax(0, 1fr)) !important; gap: 10px !important; } .hermes-stock-metrics dt { font-size: .9rem !important; } .hermes-stock-metrics dd { font-size: 1.25rem !important; } }
@media (max-width: 1080px) { .hermes-stock-row { grid-template-columns: minmax(300px, .9fr) minmax(140px, .35fr) minmax(0, 1.7fr) !important; gap: 12px !important; } .hermes-stock-row-date { padding: 7px 12px !important; font-size: .82rem !important; } .hermes-stock-metrics { grid-template-columns: repeat(5, minmax(0, 1fr)) !important; gap: 8px !important; } .hermes-stock-metrics dt { font-size: .82rem !important; } .hermes-stock-metrics dd { font-size: 1.1rem !important; } }
@media (max-width: 760px) { .hermes-stock-row { grid-template-columns: 1fr !important; gap: 18px !important; } .hermes-stock-identity, .hermes-stock-row-date, .hermes-stock-metrics { grid-column: 1 !important; } .hermes-stock-row-date { justify-self: start !important; } .hermes-stock-metrics { grid-template-columns: repeat(2, minmax(0, 1fr)) !important; gap: 16px 22px !important; } }
</style>`;
...
/* v16-canonical-stock-wrapper-spacing */
...
html, body { width: 100% !important; max-width: none !important; min-height: 100% !important; margin: 0 !important; background: #0b1020 !important; color: #eef3ff !important; }
body { box-sizing: border-box !important; padding: 32px 28px 64px !important; }
...
body > header h1, body > main > header h1, .wrap > header h1, .hero h1 { margin: 0 0 10px !important; color: #eef3ff !important; font-size: 64px !important; line-height: 1.05 !important; letter-spacing: .015em !important; }
.hermes-stock-title-row { display: flex !important; align-items: center !important; flex-wrap: wrap !important; gap: 16px !important; margin: 0 0 10px !important; }
.hermes-stock-title-row h1 { margin: 0 !important; }
.hermes-stock-heading-row { display: flex !important; align-items: flex-start !important; justify-content: space-between !important; gap: 28px !important; }
.hermes-stock-heading-row .hermes-stock-title-row { min-width: 0 !important; }
.hermes-stock-portfolio-summary { flex: 0 0 auto !important; margin-left: auto !important; text-align: right !important; font-variant-numeric: tabular-nums !important; }
.hermes-stock-summary-label { display: block !important; margin: 0 0 5px !important; color: #ffd166 !important; font-size: 22px !important; line-height: 1.1 !important; font-weight: 850 !important; letter-spacing: .08em !important; }
.hermes-stock-summary-value { display: block !important; font-size: 56.96px !important; line-height: 1.05 !important; font-weight: 400 !important; white-space: nowrap !important; }
...
html:fullscreen { overflow-y: auto !important; background: #0b1020 !important; }
body > header .date, body > main > header .date, .wrap > header .date, .hero .date { margin: 0 !important; color: #eef3ff !important; font-size: 27px !important; line-height: 1.35 !important; }
@media (max-width: 900px) { body > header h1, body > main > header h1, .wrap > header h1, .hero h1 { font-size: 48px !important; } .hermes-stock-heading-row { flex-direction: column !important; } .hermes-stock-portfolio-summary { margin-left: 0 !important; text-align: left !important; } .hermes-stock-summary-value { font-size: 42.72px !important; } }
</style>`;
...
(() => {
  ...
  function ensureHermesPlayer() {
    ...
    player.innerHTML = '<div class="hermes-player-shell"><button id="tts-prev" type="button" aria-label="Previous topic" title="Previous topic">←</button><button id="tts-toggle" type="button" aria-label="Play reading" aria-pressed="false" title="Play or pause">▶</button><button id="tts-next" type="button" aria-label="Next topic" title="Next topic">→</button><label class="hermes-player-volume"><input id="tts-volume" type="range" min="0" max="1" step="0.05" value="1" aria-label="Volume" title="Volume"></label></div>';
  ...
  function ensureDateNavigator() {
    ...
    navigator.innerHTML = '<button id="hermes-date-newer" type="button" aria-label="Load newer cron date" title="Newer cron date">‹</button><span class="hermes-date-nav-label">DATE</span><button id="hermes-date-older" type="button" aria-label="Load older cron date" title="Older cron date">›</button>';
  ...
  function configureNaturalVoice(utterance) {
    ...
    const selectedVoice = preferredVoiceNames
      ...
      .find(Boolean) || usableVoices.find((voice) => voice.localService) || usableVoices[0] || null;
  ...
  function setVolume(value) {
    ...
    volumeInput.value = String(Number.isFinite(normalized) ? normalized : 1);
    volumeDirty = true;
    if (!playing) return;
    window.clearTimeout(volumeRestartTimer);
    const restartTakeaways = speakingTakeaways;
    volumeRestartTimer = window.setTimeout(() => restartTakeaways ? playFounderTakeaways() : speakCurrent(), 120);
  }
  ...
  function init() {
    ...
    volumeInput.setAttribute("title", "Volume");
...
(() => {
  ...
  document.addEventListener("keydown", (event) => {
    ...
    const direction = event.key === "ArrowLeft" ? "newer" : event.key === "ArrowRight" ? "older" : null;
    if (!direction) return;
    event.preventDefault();
  ...
  return `<section id="hermes-portfolio-comparison" class="hermes-portfolio-comparison" aria-labelledby="hermes-portfolio-title">
    ...
    <div class="hermes-portfolio-table-wrap">
      <table class="hermes-portfolio-table" aria-label="Portfolio positions compared with current stock brief prices">
        <thead><tr><th>Position</th><th class="hermes-portfolio-shares">Shares</th><th class="hermes-portfolio-purchase">Purchased price</th><th>Current price</th><th>+/-</th><th>Cost basis</th><th>Current value</th><th>Gain / loss</th><th>Return</th></tr></thead>
        <tbody>${rows}</tbody>
        <tfoot><tr><td colspan="5">Available-position total</td><td>${usd.format(totalBasis)}</td><td>${usd.format(totalValue)}</td><td class="${totalClass}">${signedCurrency(totalGain)}</td><td class="${totalClass}">${signedPercent(totalReturn)}</td></tr></tfoot>
      </table>
    </div>
  </section>`;
}

function normalizeStockQuoteRows(html: string): string {
  ...
  const archiveDate = html.match(/<h1\b[^>]*>\s*Stock Brief\s*(?:—|&mdash;|&#8212;|-)\s*(\d{4}-\d{2}-\d{2})\s*<\/h1\s*>/i)?.[1]
    ?? html.match(/\b(?:Los\s+Angeles\s+)?date\s*:\s*(\d{4}-\d{2}-\d{2})\b/i)?.[1]
    ?? "";
  const rowDate = formatArchiveDate(archiveDate);
  const rowDatePill = rowDate
    ? `<span class="hermes-stock-row-date" role="status" aria-label="Daily prices date: ${escape(rowDate)}">${escape(rowDate)}</span>`
    : "";
  ...
  return html.replace(cardPattern, (source, _tag: string, attributes: string, body: string) => {
    ...
    const metricEntries = definitionMetrics.length ? definitionMetrics : spanMetrics.length ? spanMetrics : strongMetrics;
...
function injectStockPortfolioComparison(html: string): string {
  ...
  html = normalizeStockQuoteRows(html);
...
function normalizeAiHeroMarkup(html: string, generatedAt?: number): string {
  ...
  const escapedActiveDate = escapeText(formatArchiveDate(pillDate));
  ...
  if (escapedActiveDate && !/\bhermes-ai-active-date-pill\b/i.test(normalized)) {
    const activeDatePill = `<span class="hermes-ai-active-date-pill" role="status" aria-label="AI brief date: ${escapedActiveDate}">${escapedActiveDate}</span>`;
    normalized = normalized.replace(
      /(<h2\b[^>]*>\s*FOUNDER TAKEAWAYS\s*<\/h2\s*>)/i,
      `<div class="hermes-takeaways-heading-row">$1${activeDatePill}</div>`,
    );
    normalized = normalized.replace(
      /<(p|div)\b(?=[^>]*\bclass\s*=\s*(?:"[^"]*\bsources?\b[^"]*"|'[^']*\bsources?\b[^']*'))[^>]*>[\s\S]*?<\/\1\s*>/gi,
      (sourcesLine) => `<div class="hermes-ai-sources-row">${sourcesLine}${activeDatePill}</div>`,
    );
  }
...
function stockArchiveDate(html: string): string {
  ...
  const humanDate = html.match(/\b(?:Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday),?\s+((?:January|February|March|April|May|June|July|August|September|October|November|December)\s+\d{1,2},\s+\d{4})\b/i)?.[1];
  if (!humanDate) return "";
...
function standaloneAiExportNavigation(selectedDate: string, archiveDates: string[]): string {
  ...
  return `<style id="hermes-ai-stable-date-frame-style">
...
(() => {
  ...
  function navigate(direction, position = captureViewportPosition()) {
    ...
    const date = state.archiveDates[current + offset];
...
function standaloneExportNavigation(kind: BriefKind, selectedDate: string, archiveDates: string[]): string {
  ...
  const payload = JSON.stringify({ selectedDate, archiveDates, files }).replace(/</g, "\\u003c");
  return `<script id="hermes-brief-export-navigation-controller">
(() => {
  const state = ${payload};
...
/**
 * Preserves the archived brief's visual HTML/CSS while replacing all archived
 * JavaScript with one isolated, format-independent speech/navigation controller.
 */
export function prepareBriefPreviewHtml(html: string, kind?: BriefKind, generatedAt?: number): string {
  ...
  const stockArchiveWithoutProducerComparison = kind === "stock" ? normalizeStockArchive(aiArchiveWithHero) : aiArchiveWithHero;
  const stockArchiveWithTopComparison = kind === "stock" ? injectStockPortfolioComparison(stockArchiveWithoutProducerComparison) : stockArchiveWithoutProducerComparison;
  const normalizedArchive = kind === "stock" ? normalizeStockHeroMarkup(stockArchiveWithTopComparison, generatedAt) : stockArchiveWithTopComparison;
  ...
  const withArchiveStyle = kind === "ai"
    ...
    : kind === "stock"
      ...
      : withPlayerStyle;
  return kind === "stock"
    ? injectBeforeClosingTag(withArchiveStyle, "body", STOCK_INTERACTION_CONTROLLER)
...
export function briefDashboardHtml(
  ...
  const prepared = prepareBriefPreviewHtml(html, kind, generatedAt);
...
#hermes-brief-export-shell .hermes-export-dates [aria-current="date"] { background: #f9dec9; color: #03211f; font-weight: 800; }
  ...
  const shell = `<section id="hermes-brief-export-shell" data-hermes-exclude-from-player><div class="hermes-export-title">${title}</div><div class="hermes-export-meta">Self-contained dashboard export · ${escape(selectedDate)}</div><div class="hermes-export-dates" aria-label="Archive dates">${dates}</div></section>`;
  ...
  if (kind === "stock") {
    ...
    if (portfolioTable) {
      ...
      const tableRows = Array.from(portfolioTable.querySelectorAll("tbody tr, tfoot tr")).map((row) => {
        ...
        const unavailable = cells.find((cell) => cell.getAttribute("colspan") === "6");
        if (unavailable) return [...values.slice(0, 3), values[3], "", "", "", "", ""];
        const total = cells[0]?.getAttribute("colspan") === "5";
        if (total) return [values[0], "", "", "", "", ...values.slice(1)];
    ...
    document.querySelectorAll(".hermes-stock-row").forEach((row) => {
      ...
      const rowDate = clean(row.querySelector(".hermes-stock-row-date")?.textContent);
      ...
      if (rowDate) lines.push(`Date · ${rowDate}`);
